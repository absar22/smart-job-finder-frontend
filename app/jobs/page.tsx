    ...
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="flex justify-center items-center gap-3 mt-12">
        {page > 1 ? (
          ...
          <span className="px-5 py-2.5 rounded-full border-[1.5px] font-bold text-[13px] uppercase tracking-wide opacity-30 cursor-not-allowed select-none"
            style={{ borderColor: "oklch(80% 0.02 42.6)", fontFamily: "var(--font-inconsolata)" }}>
            ← Prev
          </span>
        )}
